...

	...
	public:
	    virtual bool getTrackableValue (IClient *pValueSink, ITicketSink *pTicketSink, VRolePlayer *pContainer) const OVERRIDE {
		Container_T *pCastContainer = 0;
	    ...
	    virtual bool getValue (IVReceiver<VString const&> *pResultSink, VRolePlayer *pContainer) const OVERRIDE {
		return getValueImpl (pResultSink, pContainer);
	    }
	    virtual bool getValue (IVReceiver<unsigned int> *pResultSink, VRolePlayer *pContainer) const OVERRIDE {
		return getValueImpl (pResultSink, pContainer);
	    }
	    virtual bool getValue (IVReceiver<unsigned __int64> *pResultSink, VRolePlayer *pContainer) const OVERRIDE {
		return getValueImpl (pResultSink, pContainer);
	    }
	    virtual bool getValue (IVReceiver<float> *pResultSink, VRolePlayer *pContainer) const OVERRIDE {
		return getValueImpl (pResultSink, pContainer);
	    }
	    virtual bool getValue (IVReceiver<double> *pResultSink, VRolePlayer *pContainer) const OVERRIDE {
		return getValueImpl (pResultSink, pContainer);
	    }
